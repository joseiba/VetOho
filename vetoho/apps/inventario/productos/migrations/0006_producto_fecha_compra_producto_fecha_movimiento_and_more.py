# Generated by Django 4.1.7 on 2023-04-22 02:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('productos', '0005_alter_tipoproducto_fecha_alta'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='producto',
            name='fecha_compra',
            field=models.CharField(default='21/04/2023', editable=False, max_length=200),
        ),
        migrations.AddField(
            model_name='producto',
        ...
        migrations.AlterField(
            ...
            name='fecha_alta',
            field=models.CharField(default='21/04/2023 22:25:00 hs', editable=False, max_length=200),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta', models.CharField(default='21/04/2023 22:25:00 hs', max_length=500, null=True)),
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productos.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_alta', models.CharField(default='21/04/2023', max_length=500, null=True)),
