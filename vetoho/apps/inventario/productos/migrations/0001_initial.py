    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_compra', models.CharField(default='08/05/2023', editable=False, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta', models.CharField(default='08/05/2023 21:49:37 hs', editable=False, max_length=200)),
                ('fecha_baja', models.CharField(blank=True, default='-', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta', models.CharField(default='08/05/2023 21:49:37 hs', max_length=500, null=True)),
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productos.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_alta', models.CharField(default='08/05/2023', max_length=500, null=True)),
