...
class ProductoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['is_active']
        widgets = {
			# 'codigo_producto' : forms.TextInput(attrs={'class':'form-control', 'name': 'codigo_producto','autocomplete': 'off' ,'placeholder': 'Codigo Producto', 'onkeyup':'aceptarNumerosYLetras(this)'}),
            'nombre_producto': forms.TextInput(attrs={'class':'form-control', 'name': 'nombre_producto', 'autocomplete': 'off' ,'placeholder': 'Nombre del producto', 'required': 'required', 'onkeyup':'aceptarLetras(this)'}),
            'descripcion' : forms.TextInput(attrs={'class':'form-control', 'name': 'descripcion', 'autocomplete': 'off' ,'placeholder': 'Descripcion', 'required': 'required', 'onkeyup':'aceptarNumerosYLetras(this)'}),
            ...
            'precio_venta': forms.TextInput(attrs={'class':'form-control', 'required':'required','name': 'precio_venta','autocomplete': 'off' , 'placeholder': 'Precio de Venta', 'onkeyup':'aceptarNumeros(this)'}),
            'stock_minimo': forms.TextInput(attrs={'class':'form-control', 'required':'required','name': 'stock_minimo','autocomplete': 'off' , 'placeholder': 'Stock Minimo', 'onkeyup':'aceptarNumeros(this)'}),
            #'stock_fisico': forms.TextInput(attrs={'class':'form-control','name': 'stock_fisico','autocomplete': 'off' , 'placeholder': 'Stock Fisico', 'onkeyup':'aceptarNumeros(this)'}),
            'lote': forms.TextInput(attrs={'class':'form-control', 'name': 'lote', 'placeholder': 'Lote', 'autocomplete': 'off' ,'id':'lote_id','onkeyup':'aceptarNumerosYLetras(this)'}),
            'stock': forms.TextInput(attrs={'id':'stock', 'required':'required','class':'form-control', 'name': 'stock', 'autocomplete': 'off' ,'placeholder': 'Stock', 'onkeyup':'aceptarNumeros(this)'}),
