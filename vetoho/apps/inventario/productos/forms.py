...
from sapps.inventario.productos.models import Producto
...
class ProductoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['is_active']
        widgets = {
			'codigo_producto' : forms.TextInput(attrs={'class':'form-control', 'name': 'codigo_producto','autocomplete': 'off' ,'placeholder': 'Codigo Producto', 'required': 'required', 'onkeyup':'aceptarNumerosYLetras(this)'}),
