...
class AgendamientosFormTest(LiveServerTestCase):
    ...
    #     submit = driver.find_element(By.XPATH,"//*[@id='calendar']/div[2]/div/table/tbody/tr/td/div/div/div/table/tbody/tr[6]/td[2]")
    #     submit.click()
    #     time.sleep(3)
    ...
    def testEditAgendamiento(self):
        ...
        #cambiar en el dia de la evaluacion
        submit = driver.find_element(By.XPATH,"//*[@id='calendar']/div[2]/div/table/tbody/tr/td/div/div/div/table/tbody/tr[6]/td[2]/div/div[2]")
        submit.click()
        time.sleep(3)        
