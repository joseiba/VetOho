# Generated by Django 3.1.6 on 2022-09-26 02:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta', models.CharField(default='25/09/2022', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta', models.CharField(default='25/09/2022 22:14:37 hs', editable=False, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_alta', models.CharField(default='25/09/2022', editable=False, max_length=200)),
                ('pedido_cargado', models.CharField(blank=True, default='N', max_length=2, null=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('is_active', models.CharField(blank=True, default='S', max_length=2, null=True)),
            ],
